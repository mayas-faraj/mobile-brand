...
const defaultMeta = {
  ...
  siteName: 'AmkInt',
  description:
    'We do trading for mobile phone, Direct partnership with samsung & oneplus ,Deal in apple samsung xiaomi oneplus oppo vivo Infinix ,We do retail , wholesale & online in UAE',
  // change base url of your web (without '/' at the end)
  url: 'https://amk-int.com',
  type: 'website',
  robots: 'follow, index',
  // change with url of your image (recommended dimension = 1.91:1)
  // used in twitter, facebook, etc. card when link copied in tweet/status 
  image: 'https://amk-int.com/assets/card-image.png',
  author: 'Mayas Faraj'
};
