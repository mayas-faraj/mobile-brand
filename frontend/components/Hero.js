  ...
  return (
    ...
    >
      <ScrollAnimationWrapper>
        <Swiper slidesPerView={1} loop={true} modules={[Autoplay]} autoplay={{ delay: 3000 }}>
          <SwiperSlide>
            <motion.div
              ...
              <div className=" flex flex-col justify-center items-start row-start-2 sm:row-start-1">
                ...
                <ButtonPrimary><Link href="/about-us"><a>Read more</a></Link></ButtonPrimary>
              </div>
          ...
          <SwiperSlide>
            <motion.div
              ...
              <div className=" flex flex-col justify-center items-start row-start-2 sm:row-start-1">
                <h1 className="text-3xl lg:text-4xl xl:text-5xl font-medium text-black-600 leading-normal">
                  We provide a host of <strong>effective</strong> distribution services.
                </h1>
                <p className="text-black-500 mt-4 mb-6">
                  allowing device manufacturers to focus on their core competencies
                </p>
                <ButtonPrimary><Link href="/about-us"><a>Read more</a></Link></ButtonPrimary>
              </div>
              <div className="flex w-full">
